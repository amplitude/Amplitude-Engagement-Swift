...
@interface UIApplication (SWIFT_EXTENSION(AmplitudeSwift))
- (BOOL)amp_sendAction:(SEL _Nonnull)action to:(id _Nullable)target from:(id _Nullable)sender for:(UIEvent * _Nullable)event SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIButton (SWIFT_EXTENSION(AmplitudeSwift))
@property (nonatomic, readonly, copy) NSString * _Nullable amp_title;
@end



@interface UIControl (SWIFT_EXTENSION(AmplitudeSwift))
- (BOOL)amp_shouldTrack:(SEL _Nonnull)action for:(id _Nullable)target SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIDatePicker (SWIFT_EXTENSION(AmplitudeSwift))
- (BOOL)amp_shouldTrack:(SEL _Nonnull)action for:(id _Nullable)target SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIGestureRecognizer (SWIFT_EXTENSION(AmplitudeSwift))
- (void)amp_setState:(UIGestureRecognizerState)state;
@end


@interface UIPageControl (SWIFT_EXTENSION(AmplitudeSwift))
- (BOOL)amp_shouldTrack:(SEL _Nonnull)action for:(id _Nullable)target SWIFT_WARN_UNUSED_RESULT;
@end



@interface UISegmentedControl (SWIFT_EXTENSION(AmplitudeSwift))
@property (nonatomic, readonly, copy) NSString * _Nullable amp_title;
- (BOOL)amp_shouldTrack:(SEL _Nonnull)action for:(id _Nullable)target SWIFT_WARN_UNUSED_RESULT;
@end


@interface UISwitch (SWIFT_EXTENSION(AmplitudeSwift))
- (BOOL)amp_shouldTrack:(SEL _Nonnull)action for:(id _Nullable)target SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIViewController (SWIFT_EXTENSION(AmplitudeSwift))
